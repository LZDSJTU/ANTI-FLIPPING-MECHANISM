function [ x_intersectFinal, y_intersectFinal ] = PointAfterMovingingWeight( xsum, ysum, FcPlus, McPlus, AddtionalWeight, pm ,H, h )
%UNTITLED 此处显示有关此函数的摘要
%   此处显示详细说明
global g;
FcFinal=FcPlus;
McFinal=McPlus+cross([xsum; ysum; 0],[0; 0; -AddtionalWeight*g]);
