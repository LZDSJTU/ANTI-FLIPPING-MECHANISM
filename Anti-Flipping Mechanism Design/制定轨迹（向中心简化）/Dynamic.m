...
%% Section 4 Read Path
load('C:\Users\hasee\Desktop\毕设MATLAB程序\配重程序\制定轨迹（极坐标调整法）\轨迹\PathPlanning_3_1.mat');trial = size(q,1);
xsum(1)=0;
ysum(1)=0;
for i = 1:trial
    ...
    [ distance, x, y ] = LocationOfWeight_circle( x_intersectPlusAndMoving, y_intersectPlusAndMoving, LEN, W, FcPlusAndMoving, AddtionalWeight );
    Location(i,1:2)=[x, y];
