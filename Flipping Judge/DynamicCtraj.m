...
% T1=zeros(4);
% T2=zeros(4);
% T1(1:3,1:3)=[0, 0, 1; 0, -1, 0; 1, 0, 0];
% T1(4,4)=1;
% T2(1:3,1:3)=[0, 0, 1; 0, -1, 0; 1, 0, 0];
% T2(4,4)=1;
% T1(1:3,4)=[0.3; 0.2; 0.4608];
% T2(1:3,4)=[0.5; 0; 0.4608];
% q1=invkine(T1);
% q2=invkine(T2);
% k=0:dt:period;
% [qplot,qdplot,qddplot] = jtraj(q1, q2, k);

load PathPlanning_2a.mat
qplot=q;
qdplot=qd;
qddplot=qdd;
for j=0:dt:period
